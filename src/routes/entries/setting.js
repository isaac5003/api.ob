...
router.get("/general", async (req, res) => {
  try {
    ...
    return res.status(500).json({
      message:
        "Error al obtener la configuracion general del modulo de contabilidad.",
    });
  }
});
...
router.put("/general", async (req, res) => {
  ...
  try {
    ...
    return res.status(500).json({
      message:
        "Error al actualizar la configuracion general del modulo de contabilidad.",
    });
  }
});
...
router.get("/signatures", async (req, res) => {
  try {
    ...
    return res.status(500).json({
      message:
        "Error al obtener el detalle de los firmantes del modulo de contabilidad.",
    });
  }
});
...
router.put("/signatures", async (req, res) => {
  ...
  try {
    ...
    return res.status(500).json({
      message:
        "Error al actualizar la configuracion de los firmantes del modulo de contabilidad.",
    });
  }
});
